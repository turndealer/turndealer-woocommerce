...
class NMM_Blockchain {	
	...
	public static function get_bnb_address_transactions($address) {
		
		$request = 'http://api.bscscan.com/api?module=account&action=txlist&address=' . $address . '&startblock=0&endblock=99999999&sort=desc';
